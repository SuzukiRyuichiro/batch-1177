...
cities = [["London", "UK", "London Eye"], ["Paris", "France", "Eiffle Tower"], ["Cape Town", "South Africa", "Table Mountain"]]
...
hash_cities = {
  ...
  "Cape Town" => { "country" => "South Africa", "landmark" => "Table Mountain", "population" => 4600000 },
}
